...
def launch_setup(context, *args, **kwargs):
    ...
    if not component_container:
        ...
        node = Node(
            package="romea_robot_to_robot_localisation_core",
            executable="robot_to_robot_"+filter_type+"_localisation_node",
            name=filter_name,
        ...
        composable_node = ComposableNode(
                package="romea_robot_to_robot_localisation_core",
                plugin="romea::R2WR2R+"+filter_type.capitalize()+"Localisation",
                name=filter_name,
                parameters=[filter_configuration],
            )
